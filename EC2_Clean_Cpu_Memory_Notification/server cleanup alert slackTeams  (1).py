...
# Slack and Teams Webhook URLs (replace with your actual URLs)
...
[bold magenta] WARNING READ THIS BEFORE RUNNING Note:[/bold magenta]
- Interactive mode is recommended for production.
- Auto mode is faster but may act on processes/files without confirmation WARNING — READ THIS BEFORE RUNNING.
[bold cyan]==========================================================[/bold cyan]
""")
...
def log_event(event, detail):
    ...
    try:
        ...
        iam_role = role_name if role_name and "Unauthorized" not in role_name else "none"
    except Exception:
        iam_role = "none"
...
=====================================================================OUTPUT========================================================================================
ubuntu@ip-172-31-32-78:~/test$ ./prod.py
...
2. Interactive Mode (2) [Default]
 ...
 WARNING READ THIS BEFORE RUNNING Note:
- Interactive mode is recommended for production.
- Auto mode is faster but may act on processes/files without confirmation WARNING — READ THIS BEFORE RUNNING.
==========================================================
...
======= SYSTEM MONITOR =======
CPU Load: 0.06, 0.06, 0.02
               total        used        free      shared  buff/cache   available
Mem:           3.8Gi       819Mi       977Mi       1.0Mi       2.1Gi       2.7Gi
Swap:             0B          0B          0B
...
│ 3282 │ 1804 │ python3         │  0.6 │  1.0 │
│  786 │    1 │ mysqld          │  0.5 │  9.8 │
│ 1463 │ 1402 │ promtail        │  0.3 │  1.4 │
│ 1470 │ 1401 │ grafana         │  0.3 │  5.9 │
